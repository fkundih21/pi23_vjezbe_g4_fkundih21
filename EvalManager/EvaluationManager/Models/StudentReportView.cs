...
namespace EvaluationManager.Models
{
    public class StudentReportView
    {
        ...
        public StudentReportView(Student student) {
            ...
            HasSignature = student.HasGrade() == true ? "DA" : "NE";
            ...
            var kolokvij1 = evaluations.FirstOrDefault(e => e.Activitiy.Name == "Kolokvij 1");
            var kolokvij2 = evaluations.FirstOrDefault(e => e.Activitiy.Name == "Kolokvij 2");
            var zadaca1 = evaluations.FirstOrDefault(e => e.Activitiy.Name == "Zadaca 1");
            var zadaca2 = evaluations.FirstOrDefault(e => e.Activitiy.Name == "Zadaca 2");
            var zadaca3 = evaluations.FirstOrDefault(e => e.Activitiy.Name == "Zadaca 3");
